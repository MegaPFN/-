...
class Chat:
    def __init__(self, msg):
        ...
        self.messages = {
            'start':'🤖 سلاپ بیبی , '+ self.user_name +'!\n\n'
                    '📩 ارسال کن:\n\n'
                    '"*/music* _اسم آهنگت_"  or\n'
                    '"*/music* _اسم خواننده - اسم اهنگ_"\n\n'
                    'برا دانلود موزیکت',
            
            'spotify_input_error':"‼️ *ببخشید فعلا اسپاتیفای پشتیبانی نمیکنم به @pfnteam بگو*\n"
                    'اینو امتحان کن: "*/music* _اسم آهنگت_"\n'
                    'or: "*/music* _اسم خواننده - اسم آهنگ_"',

            'ناشناس':'‼️ *Oops! Invalid command!*\n'
                    'Try: "*/music* _اسم آهنگ_"\n'
                    'or: "*/music* _اسم خواننده_"\n',

            'too_long':'‼️ Ziadi bozorgee*\n'
                    'باید کمتر از 30 دقیقه باشه'
    ...
    def process_request(self, user_input):
        ...
        if int(min_duration) < 30 and split_count < 3:
            ...
            downloading_message = self.send_message('در حال دانلود \n_(یکمی زمان میبره)_')
